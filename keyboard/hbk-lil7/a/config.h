...
/* USB和蓝牙的显示参数 */
#define VENDOR_ID 0x5511 /* USB VID */
#define PRODUCT_ID 0x0011 /* USB PID */
#define CONF_VENDOR_ID 0x4399 /* 配置项目内显示的VendorID */
#define CONF_PRODUCT_ID 0x000A /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0000 /* 硬件版本 */
#define MANUFACTURER "HBK_Official" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "HBK_Lil7" /* 硬件名词，用于蓝牙显示 */
...
#define UART_TXD 14 // UART_TX口IO 18
...
// 充电检测配置
#define PIN_CHARGING !P3_3 // CH554的充电检测。当P3_3拉低时表示正在充电。若不配置则禁用USB下发充电事件
#define PIN_STANDBY !P3_4 // CH554的充电检测。当P3_4拉低时表示充电完成。若不配置则只使用PIN_CHARGING作为是否充电的检测标志
