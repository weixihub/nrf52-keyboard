...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_FN1, KC_FN2, KC_FN3, KC_FN4),
	...
	KEYMAP(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MUTE, KC_VOLD, KC_VOLU, KC_TRNS, KC_UP, 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT),

	KEYMAP(
		KC_FN5, KC_MYCM, KC_MAIL, KC_CALC, KC_MSEL, KC_TRNS, KC_TRNS, KC_TRNS, KC_MPLY, KC_MPRV, KC_MNXT, KC_TRNS, KC_TRNS, KC_FN6, 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_PGDN, KC_TRNS, 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_END, KC_TRNS, 
...
const action_t fn_actions[] = {
    ACTION_MODS_TAP_KEY(MOD_RSFT, KC_UP),//按一次是后面的按键，长按是前面的
	ACTION_LAYER_TAP(1, KC_DEL),//按一次是后面的按键，长按是切换层（x）
	ACTION_MODS_TAP_KEY(MOD_RALT, KC_LEFT),
	ACTION_LAYER_TAP(2, KC_DOWN),
	ACTION_MODS_TAP_KEY(MOD_RCTL, KC_RGHT),
	ACTION_FUNCTION(3),ACTION_FUNCTION(0)
};
